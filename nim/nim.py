...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        for action in Nim.available_actions(list(state)):
            max_value = max(self.get_q_value(state,action), max_value)
        return max_value
    ...
    def choose_action(self, state, epsilon=True):
        ...
        for available_action in available_actions:
            if self.get_q_value(state, available_action) > max_value:
                max_value = self.get_q_value(state, available_action)
